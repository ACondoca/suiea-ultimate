      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <?php
              $sql = "SELECT * FROM inscricao_medio WHERE id_est = $id";
              $stmt = $pdo->query($sql);
              if ($stmt->rowCount() != 0) {
                  $count = 1; 
                  while ($rowInscricaoM = $stmt->fetch(PDO::FETCH_ASSOC)) {
                  ?>
                    <!-- Sales Card -->
                    <div class="card info-card sales-card m-5 subscription border">
                      <div class="card-header p-0 px-3 d-flex justify-content-between align-items-top" style="background-color: #00054ad4 !important; color: #fff !important;">
                        <h5 class="card-title"> <span>Inscrição <i class="icofont-simple-right"></i> SUIEA</span></h5>
                        <h5 class="card-title"><span><?php echo $rowInscricaoM['inscricao_date']; ?></span></h5>
                      </div>
                      ...
                      <div class="card-body p-3">
                        <div class="row d-flex align-items-justify justify-content-between px-3 subscription-inner">
                          ...
                          <div class="col-md-9 col-12  d-flex justify-content-start align-items-center">
                            <div class="image-content d-flex align-items-center justify-content-start" >
                              <img src="../../storage/instituições/<?=$rowInscricaoM['id_inst'];?>/imagem/<?php
                              $id_inst = $rowInscricaoM['id_inst'];
                            ...
                            <div class="ps-3 dados align-items-center justify-content-center" style="font-size: 22px !important;">
                              ...
                              ?></span></h6>
                              <h6>Curso: <span><?php
                              $id_curso = $rowInscricaoM['id_curso'];
                              ...
                              echo $row_curso['nome'];
                              ?></span></h6>
                              <h6>Estado: <span class="text-warning p-1 btn"><?php echo $rowInscricaoM['estado']; ?></span>
                              <h6>Pagamento: <span class="text-warning p-1 btn"><?php echo $rowInscricaoM['pagamento']; ?></span>
                            </div>
                          </div>

                          <div class="col-md-3 col-12 d-block align-items-center justify-content-end">

                            <button id="<?php echo $rowInscricaoM['id']; ?>" type="button" class="btn btn-primary mt-2 mb-2 w-100" data-bs-toggle="modal" data-bs-target="#ExtralargeModal<?=$rowInscricaoM['id'];?>">
                              Ver Detalhes
                            </button><?php
                            if($rowInscricaoM['estado'] == 'Aprovada' ){ 
                              $id_inscric_medio = $rowInscricaoM['id'];
                              $sql_confirm = "SELECT * FROM matricula_medio WHERE id_inscricao = $id_inscric_medio";
                              $stmt_confirm = $pdo -> query($sql_confirm);
                              if($stmt_confirm -> rowCount() == 0){
                              ?>
                              <a class="btn btn-success mt-2 mb-2 w-100" href="form-matricula.php?curso=<?=$rowInscricaoM['id_curso'];?>&inscricao=<?=$rowInscricaoM['id'];?>&utilizador=<?=$rowInscricaoM['id_est'];?>&instituicao=<?=$rowInscricaoM['id_inst'];?>&area=Ensino Médio&tagged=16253dh62fede54e4">
                                Fazer Matrícula
                              </a>
                            <?php 
                              }
                        ...
                        <div class="modal fade" id="ExtralargeModal<?=$rowInscricaoM['id'];?>" tabindex="-1">
                          <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                              <div class="modal-header border-0" style="background-color: #00054ad4 !important;">
                                <div class="card-header border-0" style="background-color: transparent !important;">
                                  <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-3">
                                      <h6 class="text-white">Detalhes da Inscrição</h6>
                                      <span class="text-success small pt-2 ps-1">Data da Inscrição |</span>
                                      <span class="text-success small pt-1 fw-bold"><?=$rowInscricaoM['inscricao_date'];?></span>
                                    </div>
                                  </div>
                                </div>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-12"><div class="profile-overview">
                                      ...
                                      <div class="row mb-3 px-2">
                                        ...
                                        <div class="col-lg-6 col-md-6 conteudo"><?=$rowInscricaoM['id'];?></div>
                                      </div>

                                      <div class="row mb-3 px-2">
                                        <div class="col-lg-6 col-md-6 label bolder ">Estado</div>
                                        <div class="col-lg-6 col-md-6 conteudo"><?=$rowInscricaoM['estado'];?></div>
                                      </div>

                                      <div class="row mb-3 px-2">
                                        <div class="col-lg-6 col-md-6 label bolder ">Pagamento</div>
                                        <div class="col-lg-6 col-md-6 conteudo"><?=$rowInscricaoM['pagamento'];?></div>
                                      </div>
                              ...
                              <div class="modal-footer border-0">
                                <button type="button" class="btn btn-primary" onclick="window.location.href='ficha-inscricao.php?register=<?=$rowInscricaoM['id'];?>&user=<?=$rowInscricaoM['id_est'];?>&area=<?=$areay; ?>'">Descarregar pdf</button>
            ...
            <?php
              $sql = "SELECT * FROM inscricao_superior WHERE id_est = $id";
              $stmt = $pdo->query($sql);
              if ($stmt->rowCount() != 0) {
                  $count = 1; 
                  while ($rowInscricao = $stmt->fetch(PDO::FETCH_ASSOC)) {
                  ?>
                    <!-- Sales Card -->
                    <div class="card info-card sales-card m-5 subscription">
                      <div class="card-header p-0 px-3 d-flex justify-content-between align-items-top" style="background-color: #00054ad4 !important; color: #fff !important;">
                        <h5 class="card-title"> <span>Inscrição <i class="icofont-simple-right"></i> SUIEA</span></h5>
                        <h5 class="card-title"><span><?php echo $rowInscricao['inscricao_date']; ?></span></h5>
                      </div>
                      ...
                      <div class="card-body p-3">
                        <div class="row d-flex align-items-justify justify-content-between px-3 subscription-inner">
                          ...
                          <div class="col-md-9 col-12  d-flex justify-content-start align-items-center">
                            <div class="image-content d-flex align-items-center justify-content-start" >
                              <img src="../../storage/instituições/<?=$rowInscricao['id_inst'];?>/imagem/<?php
                              $id_inst = $rowInscricao['id_inst'];
                              $stmt_inst = $pdo->prepare("SELECT imagem FROM instituicao WHERE id_instituicao = :id_inst");
                              $stmt_inst->bindParam(':id_inst', $id_inst);
                              $stmt_inst->execute();
                              $row_inst = $stmt_inst->fetch(PDO::FETCH_ASSOC);
                            ...
                            <div class="ps-3 dados align-items-center justify-content-center" style="font-size: 22px !important;">
                              ...
                              ?></span></h6>
                              <h6>Curso: <span><?php 
                              $id_curso = $rowInscricao['id_curso'];
                              ...
                              echo $row_curso['nome'];
                              ?></span></h6>
                              <h6>Estado: <span class="text-warning p-1 btn"><?php echo $rowInscricao['estado']; ?></span>
                              <h6>Pagamento: <span class="text-warning btn"><?php echo $rowInscricao['pagamento']; ?></span>
                            </div>
                          </div>

                          <div class="col-md-3 col-12 d-block align-items-center justify-content-end">

                            <button id="<?php echo $rowInscricao['id']; ?>" type="button" class="btn btn-primary mt-2 mb-2 w-100" data-bs-toggle="modal" data-bs-target="#ExtralargeModal2<?=$rowInscricao['id'];?>">
                              Ver Detalhes
                            </button><?php
                            if($rowInscricao['estado'] == 'Aprovada' ){ 
                                $id_inscric_superior = $rowInscricao['id'];
                                $sql_confirm2 = "SELECT * FROM matricula_superior WHERE id_inscricao = $id_inscric_superior";
                                $stmt_confirm2 = $pdo -> query($sql_confirm2);
                                if($stmt_confirm2 -> rowCount() == 0){
                              ?>
                              <a class="btn btn-success mt-2 mb-2 w-100" href="form-matricula.php?curso=<?=$rowInscricao['id_curso'];?>&inscricao=<?=$rowInscricao['id'];?>&utilizador=<?=$rowInscricao['id_est'];?>&instituicao=<?=$rowInscricao['id_inst'];?>&area=Ensino Superior&tagged=16253dh62fede54e4">
                                Fazer Matrícula
                              </a>
                              <?php 
                                }
                        ...
                        <!-- Start Extra Large Modal-->
                        <div class="modal fade" id="ExtralargeModal2<?=$rowInscricao['id'];?>" tabindex="-1">
                              <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                  <div class="modal-header border-0" style="background-color: #00054ad4 !important;">
                                    <div class="card-header border-0" style="background-color: transparent !important;">
                                      <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                          <h6 class="text-white">Detalhes da Inscrição</h6>
                                          <span class="text-success small pt-2 ps-1">Data da Inscrição |</span>
                                          <span class="text-success small pt-1 fw-bold"><?=$rowInscricao['inscricao_date'];?></span>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-12"><div class="profile-overview">
                                          ...
                                          <div class="row mb-3 px-2">
                                            <div class="col-lg-6 col-md-6 label bolder  ">Processo nº</div>
                                            <div class="col-lg-6 col-md-6 conteudo"><?=$rowInscricao['id'];?></div>
                                          </div>

                                          <div class="row mb-3 px-2">
                                            <div class="col-lg-6 col-md-6 label bolder ">Estado</div>
                                            <div class="col-lg-6 col-md-6 conteudo"><?=$rowInscricao['estado'];?></div>
                                          </div>

                                          <div class="row mb-3 px-2">
                                            <div class="col-lg-6 col-md-6 label bolder ">Pagamento</div>
                                            <div class="col-lg-6 col-md-6 conteudo"><?=$rowInscricao['pagamento'];?></div>
                                          </div>
                                  ...
                                  <div class="modal-footer border-0">
                                    <button type="button" class="btn btn-primary" onclick="window.location.href='ficha-inscricao.php?register=<?=$rowInscricao['id'];?>&user=<?=$rowInscricao['id_est'];?>&area=<?=$areax; ?>'">Descarregar pdf</button>
                                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Fechar</button>
                                  </div>
                                </div>
                              </div>
              ...
              $sql_super = "SELECT * FROM inscricao_superior WHERE id_est = $id";
              $stmt_super = $pdo->query($sql_super);
              $sql_med = "SELECT * FROM inscricao_medio WHERE id_est = $id";
              ...
              if (($stmt_super->rowCount() == 0) && ($stmt_med->rowCount() == 0)){?>
                <div class="d-flex justify-content-center align-items-center p-5" style="height: 700px;">
                  <h5 class="text-center">Ainda não tens inscrições feitas!</h5>
                </div>
              <?php
              }
            ?>
