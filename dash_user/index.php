      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <!-- Breadcrumbs -->
            <div class="breadcrumbs overlay d-flex align-items-center" id="home-student">
              <div class="container">
                <div class="bread-inner">
                  <div class="row">
                    <div class="col-12">
                      <h2>Bem-vindo(a) ao suiea</h2>
                      <ul class="bread-list">
                        ...
                        <div class="col-12">
                          ...
                          <div class="single-main">
                            ...
                            <section class="paginacao">
                                ...
                                <div class="main-sidebar mt-0">
                                  ...
                                  <div class="single-widget search ">
                                    <form action="search.php" method="GET">
                                      <div class="form">
                                        <input type="text" id="inputsearch" name="search" placeholder="Digite a sua pesquisa aqui..." class="border">
                              ...
                              <div id="exibirsearch"></div>
                                <div class="pagina">
                  
                                    <?php

                                      $sql = "SELECT * FROM instituicao WHERE estado = 'Aprovada' LIMIT 6";
                    ...
                    <div class="col-lg-4 col-12">
                      <div class="main-sidebar">
                        ...
                        <div class="single-widget category" style="margin-top: 30px;">
                          <h3 class="title"><span>Instituições mais pesquisadas</span></h3>
                          <ul class="categor-list">
                            <?php
                              $sql = "SELECT * FROM instituicao LIMIT 6";
                              $stmt = $pdo->prepare($sql);
                              $stmt->execute();           
                              if ($stmt->rowCount() != 0) {
                              $count = 1; 
                              while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {?>
                                <li><div><i class="icofont icofont-ui-check"></i> <span><?=$row['nome'];?></span> </div></li>
                            <?php
                              }
                            }
                            ?>
                        ...
                        <!-- Single Widget -->
                        <div class="single-widget category" style="margin-top: 30px;">
                          <h3 class="title"><span>Cursos mais requisitados</span></h3>
                          <ul class="categor-list">
                          <?php
                              $sql = "SELECT * FROM curso_medio LIMIT 5";
                              $stmt = $pdo->prepare($sql);
                              $stmt->execute();           
                              if ($stmt->rowCount() != 0) {
                              $count = 1; 
                            ...
                            $sql = "SELECT * FROM curso_superior LIMIT 5";
                              $stmt = $pdo->prepare($sql);
                              $stmt->execute();           
                              if ($stmt->rowCount() != 0) {
                              $count = 1; 
