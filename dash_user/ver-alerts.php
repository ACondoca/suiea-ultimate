...
<body class="toggle-sidebar">
  ...
  <main id="main" class="main p-0" style="background: #fff;">

    <div class="pagetitle p-3">
      <h1>Notificações</h1>
    </div><!-- End Page Title -->

    <section class="section dashboard px-3">
      <div class="row">
          ...
          <div class="ver-alerts">
            <div class="card-body">
              ...
              <?php
                ...
                $sql = "SELECT * FROM notificacao_utilizador INNER JOIN utilizador ON notificacao_utilizador.id_est = utilizador.id_utilizador WHERE id_utilizador = $id";
                $stmt = $pdo->query($sql);
                if ($stmt->rowCount() != 0) {
                  $count = 1; 
