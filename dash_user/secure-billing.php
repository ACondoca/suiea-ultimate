<?php
  ...
  if(isset($_GET['register']) && isset($_GET['area']) && isset($_GET['curso']) && isset($_GET['inst']) && isset($_GET['user'])){
                ...
                <div class="row pb-2">
                  <div class="col-12">
                    <div class="p-3">
                      ...
                      <p class="pt-3 text-center text-bolder" style="color:#000; font-size: 28px;"> AKZ <span style="color:#000; font-size: 32px;" id=""><?=$insc_val;?></span> </p>
                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="input-group input-group-outline mb-3">
                      ...
                      <input type="hidden" class="form-control" name="tipo" value="pagarInscricao">
                      ...
                      <input type="hidden" class="form-control" name="register" value="<?=$id_inscricao;?>">
                    </div>
                  </div>
                </div>
