              ...
              <section class="news-single section pt-5">
                <div class="container">
                  <div class="row" style="min-height: 100vh;">
                    <?php
                        if(isset($_GET['mark']) && isset($_GET['area']) && isset($_GET['user'])){
                            $id_user = $_GET['user'];
                            $area = $_GET['area'];
                    ...
                    <div class="col-12">
                        ...
                        <h3 class="d-flex justify-content-center align-items-center">
                            <a href="comprovativo2.php?mark=<?=$id_matricula;?>&area=<?=$area;?>&user=<?=$id_user;?>&tagged=14253dhst875846" class="btn btn-primary m-1">Comprovativo de Pagamento</a>
                        </h3>
                    </div>
