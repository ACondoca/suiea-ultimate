                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <ul class="bread-list">
                        ...
                        <li class="active">Ensino Médio</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class="row mb-5">
                  <div class="col-lg-12">
                    <div class="section-title text-center">
                      <h2>Instituições do <span id="tipo_instituicao">Ensino Médio</span></h2>
                  ...
                  <div class="container-fluid">
                    ...
                    <section>
                      ...
                      <?php
                        ...
                        $sql = "SELECT * FROM instituicao INNER JOIN inst_medio ON instituicao.id_instituicao = inst_medio.id WHERE estado = 'Aprovada' LIMIT 12";
                ...
                <div class="row mt-5 mb-5">
                  <div class="col-lg-12">
                    <div class="section-title mb-0 pt-5 text-center">
                      <h2>Instituições do Ensino Médio mais pesquisadas</h2>
                    </div>
                  </div>
                </div>
