            ...
            <div class="col-xl-6 col-lg-6 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
              <div class="card card-plain">
                <div class="card-header">
                  <h4 class="font-weight-bolder" style="color: #00054ad4;">Cadastrar Utilizador</h4>
                ...
                <form action="../../controller/auth/authController.php" method="POST" enctype="multipart/form-data">
                  <div class="input-group input-group-outline mb-3">
                    ...
                    <input type="hidden" value="newuser" class="form-control" name="tipo">
                  </div>
                  ...
                  <div class="input-group input-group-outline mb-3">
                    <label class="form-label">Nº Bilhete de Identidade</label>
                    <input type="text" class="form-control" name="n_bi" required>
                  </div>
                  ...
                  <label class="">Selecione uma imagem</label>
                  <div class="input-group input-group-outline mb-3">
