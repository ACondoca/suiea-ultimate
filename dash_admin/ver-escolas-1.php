    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="ver-escolas-1.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Ensino Médio</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-12 mb-5">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Estatística | Escolas do Ensino Médio</h5>
              ...
              <?php
                ...
                $sql_total2 = "SELECT nome FROM instituicao INNER JOIN inst_medio ON instituicao.id_instituicao = inst_medio.id";
              ...
              <script>
                document.addEventListener("DOMContentLoaded", () => {
                  new ApexCharts(document.querySelector("#pieChart"), {
                    ...
                    labels: ['Instituições', 'Escolas do Ensino Médio']
                  }).render();
                });
              </script>
              <!-- End Pie Chart -->
            ...
            <div class="card">
              <div class="card-body">
                ...
                <table class="table datatable">
                  ...
                  <tbody>
                    <?php 
                      $sql_total_inscricoes1 = "SELECT * FROM instituicao INNER JOIN inst_medio ON instituicao.id_instituicao = inst_medio.id ORDER BY instituicao.id_instituicao DESC";
                                      ...
                                      <div class="col-xxl-4 col-md-4">
                                        ...
                                        <div class="card info-card sales-card p-0">
                                          <div class="card-body p-0">
                                            <div class="w-100 p-0">
                                              ...
                                              <input type="hidden" name="tipo" value="AprovarInst">
                                        ...
                                        <div class="card info-card sales-card p-0">
                                          <div class="card-body p-0">
                                              <div class="w-100 p-0">
                                                <form class="p-0" action="../../controller/auth/authController.php" method="POST" enctype="multipart/form-data">
                                                <input type="hidden" name="tipo" value="BlockInst">
                                                <input type="hidden" name="inst" value="<?=$rowInsc['id_instituicao'];?>">
