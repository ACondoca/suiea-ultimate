...
<body class="toggle-sidebar">
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard" style="background: #fff;">
      <div class="row">
          ...
          <div class="ver-alerts">
            <div class="card-body">
              ...
              <?php
                ...
                $sql = "SELECT * FROM notificacao_admin INNER JOIN utilizador ON notificacao_admin.id_est = utilizador.id_utilizador WHERE id_utilizador = $id";
                $stmt = $pdo->query($sql);
                if ($stmt->rowCount() != 0) {
                  $count = 1; 
