  ...
  <main id="main" class="main">
          ...
          <div class="row">
            ...
            <div class="col-xxl-6 col-md-6">
              <div class="card info-card sales-card">
                <?php
                  //Matricula medio
                  $sql_total_inscricoes1 = "SELECT * FROM matricula_medio";
                  ...
                  //Matricula superior
                  $sql_total_inscricoes2 = "SELECT * FROM matricula_superior";
                  ...
                  //matricula medio pendente
                  $sql_total_inscricoes12 = "SELECT COUNT(*) as total FROM matricula_medio WHERE estado like 'Pendente'";
                  ...
                  //matricula superior pendente
                  $sql_total_inscricoes22 = "SELECT COUNT(*) as total FROM matricula_superior WHERE estado like 'Pendente'";
            ...
            <div class="col-xxl-6 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Matrículas Pendentes</h5>
    ...
    <section class="section">
      <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Lista de Matrículas do Ensino Médio</h5>
                                      ...
                                      <div class="card info-card sales-card">
                                        ...
                                        <div class="card-footer">
                                          ...
                                          <div class="profile-overview">
                                            ...
                                            <h5 class="card-title">Dados da Matrícula</h5>
    ...
    <section class="section pt-5">
      <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Lista de Matrícula do Ensino Superior</h5>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <td><?=$rowInscSup['matricula_date'];?></td>
                  <td><?php
                             ...
                             <div class="card-header border-0" style="background: transparent !important; color: #fff;">
                               <div class="d-flex align-items-center">
                                 ...
                                 <div class="ps-3" style="color: #fff !important;">
                                   <h6 style="color: #fff !important;">Detalhes da Matrícula</h6>
                                   <span class="text-success small pt-2 ps-1">Data da Matrícula: </span>
                                   <span class="text-success small pt-1 fw-bold"><?=$rowInscSup['matricula_date'];?></span>
                                 </div>
                               </div>
                             </div>
                                    ...
                                    <div class="col-xxl-4 col-md-4">
                                      ...
                                      <div class="card info-card sales-card">
                                        ...
                                        <div class="card-body text-center">
                                          <div class="d-flex align-items-center justify-content-center w-100 mt-3">
                                            <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                                              <button type="button" onclick="window.location.href='<?=$rowInscSup['certificado'];?>'" class="btn btn-primary rounded-circle d-flex align-items-center justify-content-center">
                                                <i class="bi bi-file-text" style="font-size: 32px;"></i>
                                              </button>
                                            </div>
                                            <div class="ps-2">
                                        ...
                                        <div class="card-body text-center">
                                          <div class="d-flex align-items-center justify-content-center w-100 mt-3">
                                            <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                                              <button type="button" onclick="window.location.href='<?=$rowInscSup['atestado_medico'];?>'" class="btn btn-primary rounded-circle d-flex align-items-center justify-content-center">
                                                <i class="bi bi-file-text" style="font-size: 32px;"></i>
                                              </button>
                                            </div>
                                            <div class="ps-2">
                                        ...
                                        <div class="card-body text-center">
                                          <div class="d-flex align-items-center justify-content-center w-100 mt-3">
                                            <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                                              <button type="button" onclick="window.location.href='<?=$rowInscSup['cartao_vacina'];?>'" class="btn btn-primary rounded-circle d-flex align-items-center justify-content-center">
                                                <i class="bi bi-file-text" style="font-size: 32px;"></i>
                                              </button>
                                            </div>
                                            <div class="ps-2">
